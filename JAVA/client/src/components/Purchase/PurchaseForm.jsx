...
const PurchaseForm = (props) => {
    ...
    <form className="m-auto col-lg-4 col-md-6 col-sm-12" id="contactForm" style={{minWidth:"50%"}} >
        ...
        <div className="form-floating mb-3">
            <input className="form-control" id="start_date" type="date" placeholder="Coverage Start Date"name="cover_start_date" defaultValue={props.data.start_date} required onChange={
                (e)=>{
