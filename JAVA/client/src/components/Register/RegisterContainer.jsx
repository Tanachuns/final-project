...
const RegisterContainer = (props) => {
    ...
    <div className="container py-5 ">
       ...
       <div className="form-floating mb-3 ">
        ...
        <div className="form-floating mb-3">
            <input className="form-control" id="password" type="password" placeholder="Password" name="password" required  onChange={(e)=>changeHandler(e)}/>
