...
public class PdfGeneratorService {
    public void export(HttpServletResponse response, OrderEntity order) throws DocumentException, IOException {
        ...
        Paragraph citizen_id = new Paragraph("Citizen Id :  " + order.getCitizen_id() + Chunk.NEWLINE, fontNormal);
        ...
        Paragraph plan_desc = new Paragraph("Description :  " + order.getPlan().getDesc() + Chunk.NEWLINE, fontNormal);

        Paragraph plan_price = new Paragraph("Price :  " + order.getPlan().getPrice() + Chunk.NEWLINE, fontNormal);
