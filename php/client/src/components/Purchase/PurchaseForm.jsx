...
const PurchaseForm = (props) => {
    ...
    <form className="m-auto col-lg-4 col-md-6 col-sm-12" id="contactForm" style={{minWidth:"50%"}} >
        ...
        <div className="form-floating mb-3">
            <input className="form-control" id="amphur" type="text" placeholder="Amphur"name="address_amphur" defaultValue={props.data.address_amphur} required onChange={(e)=>props.fromHandler(e)} />
        ...
        <div className="form-floating mb-3">
            <input className="form-control" id="province" type="text" placeholder="Province"name="address_province" defaultValue={props.data.address_province} required onChange={(e)=>props.fromHandler(e)} />
        ...
        <div className="form-floating mb-3">
            <textarea style={{height:"10em"}} className="form-control " id="plan_dsc"  type="text-area" placeholder="Plan Description"name="plan_desc" defaultValue={props.plan.description} disabled onChange={(e)=>props.fromHandler(e)} ></textarea>
        ...
        <div className="form-floating mb-3">
            <input className="form-control" id="start_date" type="date" placeholder="Coverage Start Date"name="cover_start_date" defaultValue={props.data.cover_start_date} required onChange={
                (e)=>{
                    props.dateChangeHandler(e)
                    props.fromHandler(e)
                }
        ...
        <div className="form-floating mb-3">
            <input className="form-control" id="end_date" type="date" placeholder="Coverage End Date"name="cover_end_date" defaultValue={props.data.cover_end_date} required onChange={(e)=>props.fromHandler(e)} />
