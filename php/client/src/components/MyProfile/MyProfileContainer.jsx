...
const MyProfileContainer = (props) => {
    ...
    <div className="container py-5">
       ...
       <p>Register ID : {data&&data.reg_id}</p>
       <p>Register Date : {data&&data.created_at.split("T")[0]}</p>
       <p>Edit Date : {data&&data.updated_at.split("T")[0]}</p>
        ...
        <div className="form-floating mb-3">
            <input className="form-control" id="citizen_id" disabled type="text" placeholder="Citizen ID" name="citizen_id"defaultValue={data&&data.citizen_id} onChange={(e)=>changeHandler(e)} />
