...
public class UserEntity {
    ...
    public UserEntity(String citizen_id, String email, String password) {
        this.citizen_id = citizen_id;
        this.email = email;
        this.password = password;
    }

    public UserEntity(Integer id, String title, String firstname, String lastname, String birth_date, String citizen_id,
